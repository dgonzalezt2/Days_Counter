        ...
        <ul className="social-links">
          <li className="Github icon">
            <a href="https://github.com/dgonzalezt2">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="#560419">
          ...
          <li className="twitter icon">
            <a href="https://twitter.com/David2126133/">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="22" fill="#560419">
